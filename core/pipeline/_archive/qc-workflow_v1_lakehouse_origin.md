...
> 📌 BẢN ARCHIVE — copy từ `common/processes/knowledge-pipeline/QC_AI_Workflow_Lakehouse_v1.md` ngày 2026-06-25.
> Mục đích: lưu tổ tiên của CORE trong dòng đời pipeline. Bản gốc tại `common/` GIỮ NGUYÊN.
> Nội dung dưới đây giữ nguyên 100% bản gốc.
